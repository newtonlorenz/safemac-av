...
- The Finder extension must be signed with the app, share the same App Group entitlement, and be enabled manually in System Settings. Forks also need their own compatible bundle/app-group configuration.
